...
class MedicoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addAction('Novo',  new TAction(array('MedicoForm', 'onEdit')), 'fa:plus green');
        ...
        $this->datagrid->addColumn($nome_medico);
        $this->datagrid->addColumn($espec2);
        $this->datagrid->addColumn($crm2);
        $this->datagrid->addColumn($email);
        

        // fim data grid
        $actionEdit = new TDataGridAction(array('MedicoForm', 'onEdit'));
    ...
    function Delete( $param = NULL )
    {
        try {
            ...
            $object = new Medico ($param['key']); // SEU RECORD <
