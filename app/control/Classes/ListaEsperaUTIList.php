 ...
 * @author Alefe
 */
class ListaEsperaUTIList extends TPage
{
    protected $form;
    protected $datagrid;
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('list_lista_espera_UTI');
        $this->form->setFormTitle('Lista Espera UTI');
        ...
        $this->form->addAction('Novo',  new TAction(array('ListaEsperaUTIForm', 'onEdit')), 'fa:plus green');
        ...
        $this->datagrid->addColumn($acompID);
        $this->datagrid->addColumn($prio);
        // fim data grid
        $actionEdit = new TDataGridAction(array('ListaEsperaUTIForm', 'onEdit'));
